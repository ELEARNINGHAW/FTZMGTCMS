...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e9efb55a7af84_07929459',
...
function content_5e9efb55a7af84_07929459 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_callable('smarty_function_anchor')) require_once '/rzbd/nas/HomeS/FTZMGT/WWW/lib/plugins/function.anchor.php';
if (!is_callable('smarty_function_root_url')) require_once '/rzbd/nas/HomeS/FTZMGT/WWW/lib/plugins/function.root_url.php';
if (!is_callable('smarty_function_global_content')) require_once '/rzbd/nas/HomeS/FTZMGT/WWW/lib/plugins/function.global_content.php';
...
/images/FTZMGTHAWLogo.png'  alt='<?php echo smarty_function_sitename(array(),$_smarty_tpl);?>
' />
                        </a>
                    </div>
                    <!-- .logo //-->
                ...
                <div class='row header-bottom'>
                    <section class='phrase cf'>
                        <span class='seven-col phrase-text'>Forschungs Transfer Zentrum<br class='lt-768' /> Medizin Gesundheit Technik</span>
